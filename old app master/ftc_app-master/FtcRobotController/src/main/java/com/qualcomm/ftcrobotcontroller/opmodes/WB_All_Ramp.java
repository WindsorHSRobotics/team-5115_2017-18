...
public class WB_All_Ramp extends LinearOpMode {
...
// This loop will allow the robot to move in reverse for Sleep(10) * 250 or until it detects a color
        ...
        for(loopcounter = 0;loopcounter <150; loopcounter++) {
            ...
            if (sensorRGB_Front.blue() > 2.5 || sensorRGB_Front.red() > 2.5) {
                ...
                M3.setPower(1);
                M4.setPower(1);
                sleep(375);    //rotate 45 and face the front of ramp
                M1.setPower(0.5);
                M2.setPower(-0.5);
                M3.setPower(0.5);
                M4.setPower(-0.5);
                sleep(1250); // move forward and get in front of ramp
                M1.setPower(-1);
                M2.setPower(-1);
                M3.setPower(-1);
                M4.setPower(-1);
                sleep(700);    //rotate -90 degrees
                M1.setPower(0.5);
                M2.setPower(-0.5);
                M3.setPower(0.5);
                M4.setPower(-0.5);
                sleep(900); // move forward and get on the ramp
                break;
            } else {
