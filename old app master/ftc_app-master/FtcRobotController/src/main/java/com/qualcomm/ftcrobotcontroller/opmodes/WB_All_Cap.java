...
public class WB_All_Cap extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
     ...
     //   sleep(1000);
        ...
        M3.setPower(1);
        M4.setPower(-1);
        sleep(2750);        //move foward up to the wall
        ...
        // This is the start of the generic Blue Side Beacon coce
        M1.setPower(0.4);
        M2.setPower(0.4);
        M3.setPower(-0.4);
        M4.setPower(-0.4);
     ...
     //   final float values4[] = hsvValuesfront;
        ...
        for(loopcounter = 0;loopcounter <250;loopcounter++) {
           ...
           //red beacon code
                ...
                M3.setPower(-0.5);
                M4.setPower(0.5);
                sleep(250);//move reverse  to get away from the beacon
        ...
        // THis is the end of the Generic Blue beacon code
