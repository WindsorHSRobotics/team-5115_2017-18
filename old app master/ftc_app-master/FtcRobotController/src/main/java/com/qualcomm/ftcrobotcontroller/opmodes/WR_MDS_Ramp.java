...
public class WR_MDS_Ramp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        M3.setPower(.3);
        M4.setPower(-.3);
        sleep(500);      //move foward and get the robot off the wall
        ...
        M3.setPower(1);
        M4.setPower(-1);
        sleep(1000);        //move foward up to the cap
        ...
        M3.setPower(1);
        M4.setPower(-1);
        sleep(1300);        //move foward up the ramp
