...
public class WR_CDS_Cap extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        M3.setPower(.3);
        M4.setPower(-.3);
        sleep(1100);      //move foward and get the robot to the right spot to shoot
       ...
       /* M1.setPower(1);
        ...
        M3.setPower(1);
        M4.setPower(1);
        sleep(100);       //rotate 10 degrees to point at the cap */

        M1.setPower(1);
        M2.setPower(-1);
        M3.setPower(1);
        M4.setPower(-1);
        sleep(2100);        //move foward to the cap
