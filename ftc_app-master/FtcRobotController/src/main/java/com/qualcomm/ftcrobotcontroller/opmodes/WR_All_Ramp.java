...
public class WR_All_Ramp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        M3.setPower(.3);
        M4.setPower(-.3);
        sleep(500);      //move foward and get the robot off the wall needs to move more foward
        ...
        launcher.setPower(1);
        sleep(5000);   //launch particles for 4.5 seconds - three flipper turns
        ...
        M3.setPower(-1);
        M4.setPower(-1);
        sleep(300);       //rotate 45 degrees

        M1.setPower(0);
        M2.setPower(0);
        M3.setPower(0);
        M4.setPower(0);
        sleep(200); //  Settle the robot before moving

        M1.setPower(1);
        M2.setPower(-1);
        M3.setPower(1);
        M4.setPower(-1);
        sleep(2400);        //move foward up to the wall

        M1.setPower(0);
        M2.setPower(0);
        M3.setPower(0);
        M4.setPower(0);
        sleep(200);  // Settle the robot before spinning

        M1.setPower(1);
        M2.setPower(1);
        M3.setPower(1);
        M4.setPower(1);
        sleep(325);    //rotate 45 degrees in the opposite direction

        M1.setPower(0);
        M2.setPower(0);
        M3.setPower(0);
        M4.setPower(0);
        sleep(200);  // Settle the robot
...
// This loop will allow the robot to move in reverse for Sleep(10) * 250 or until it detects a color
        for(loopcounter = 0;loopcounter <250;loopcounter++){
            ...
            if(sensorRGB_Back.blue()>2.5 && sensorRGB_Back.blue()>sensorRGB_Back.red() && sensorRGB_Back.blue()>sensorRGB_Back.green()){
                telemetry.addData("color_back = ", "blue");

                Arm.setPosition(0);// raise the arm and get it out of the way - We want Red
                M1.setPower(-0.5);
                M2.setPower(0.5);
                M3.setPower(-0.5);
                M4.setPower(0.5);
                sleep(800);//move reverse past blue light
                ...
                M2.setPower(-0.2);
                M3.setPower(0.2);
                M4.setPower(-0.4); // This might need to go to -0.4 to pull the front of the robot past the button towards the wall
                sleep(1000); // move forward and hit RED beacon

                M1.setPower(0.5);
                M2.setPower(-0.5);
                M3.setPower(0.5);
                M4.setPower(-0.5);
                sleep(400);//move faster to next beacon
                break;// THis stops the for loop and jumps below it
                // Blue beacon code
            }
            else if(sensorRGB_Back.red()>2.5 && sensorRGB_Back.red()>sensorRGB_Back.green() && sensorRGB_Back.red()>sensorRGB_Back.blue()){
                telemetry.addData("color_back = ", "red" );
                //red beacon code
                Arm.setPosition(.55); //Set arm down to hit the RED beacon
                M1.setPower(0.4);
                M2.setPower(0.4);
                M3.setPower(-0.4);
                M4.setPower(-0.4);
        ...
        for(loopcounter = 0;loopcounter <250;loopcounter++) {
            ...
            if (sensorRGB_Front.blue() > 2.5 && sensorRGB_Front.blue() > sensorRGB_Front.red() && sensorRGB_Front.blue() > sensorRGB_Front.green()) {
                ...
                M3.setPower(0.5);
                M4.setPower(-0.5);
                sleep(400);//move forward past the beacon
            ...
            } else if (sensorRGB_Front.red() > 2.5 && sensorRGB_Front.red() > sensorRGB_Front.green() && sensorRGB_Front.red() > sensorRGB_Front.blue()) {
                ...
                M3.setPower(-0.5);
                M4.setPower(0.5);
                sleep(500);//Back up to gain speed
                ...
                sleep(1300); //move forward and hit button and up the wall towards ramp
        ...
        for(loopcounter = 0;loopcounter <150; loopcounter++) {
            Color.RGBToHSV(sensorRGB_Back.red() * 8, sensorRGB_Back.green() * 8, sensorRGB_Back.blue() * 8, hsvValuesfront);
            if (sensorRGB_Back.blue() > 2.5 || sensorRGB_Back.red() > 2.5) {
                M1.setPower(-0.4);
                M2.setPower(-0.4);
                M3.setPower(0.4);
                M4.setPower(0.4);
                sleep(500);   // move right off the wall
                M1.setPower(1);
                M2.setPower(1);
                M3.setPower(1);
                M4.setPower(1);
                ...
                M3.setPower(0.5);
                M4.setPower(-0.5);
                sleep(1200); // move forward halfway to the cap ball
                M1.setPower(1);
                M2.setPower(1);
                M3.setPower(1);
                M4.setPower(1);
                sleep(375);    //rotate 45 and face away from beacon wall
                M1.setPower(0.5);
                M2.setPower(-0.5);
                M3.setPower(0.5);
                M4.setPower(-0.5);
                sleep(1200); // move to alignment with corner
                M1.setPower(1);
                M2.setPower(1);
                M3.setPower(1);
                M4.setPower(1);
                sleep(750);    //rotate 45 and face the corner
                M1.setPower(0.5);
                M2.setPower(-0.5);
                M3.setPower(0.5);
                M4.setPower(-0.5);
                sleep(2000); // move to the ramp and park
                break;
            } else {
